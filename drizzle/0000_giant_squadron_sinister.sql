...
CREATE TYPE "public"."company_type" AS ENUM('platform', 'postal', 'air_partner', 'customs_broker', 'airline');--> statement-breakpoint
...
ALTER TABLE "flight_expenses" ADD CONSTRAINT "flight_expenses_flight_id_flights_id_fk" FOREIGN KEY ("flight_id") REFERENCES "public"."flights"("id") ON DELETE no action ON UPDATE no action;